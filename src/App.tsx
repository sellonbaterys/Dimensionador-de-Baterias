    ...
    <div className="animate-[fadeIn_0.6s_cubic-bezier(0.22,1,0.36,1)] py-8 px-4">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-slate-400 max-w-2xl mx-auto font-light leading-relaxed">
          Maximize sua lucratividade com dimensionamento profissional. A ferramenta definitiva para vender sistemas de armazenamento de alto valor e segurança energética.
        </p>
      </div>
